...
describe('Service Tests', () => {
    ...
    describe('VoucherValuationType Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(VoucherValuationTypeService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/voucher-valuation-types';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return VoucherValuationType', () => {
