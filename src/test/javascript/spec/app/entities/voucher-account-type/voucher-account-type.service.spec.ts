...
describe('Service Tests', () => {
    ...
    describe('VoucherAccountType Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(VoucherAccountTypeService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/voucher-account-types';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return VoucherAccountType', () => {
