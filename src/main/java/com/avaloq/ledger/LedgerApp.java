package com.avaloq.ledger;

import com.avaloq.ledger.config.ApplicationProperties;
import com.avaloq.ledger.config.DefaultProfileUtil;
...
public class LedgerApp {
    ...
    public LedgerApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(LedgerApp.class);
