...
public class LedgerAccountResource {
    ...
    @Timed
    public ResponseEntity<LedgerAccount> createLedgerAccount(@Valid @RequestBody LedgerAccount ledgerAccount) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<LedgerAccount> updateLedgerAccount(@Valid @RequestBody LedgerAccount ledgerAccount) throws URISyntaxException {
